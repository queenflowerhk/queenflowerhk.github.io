        ...
        return `
            <div class="product-card bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl group fade-in relative" style="animation-delay: ${index * 0.1}s">
                ...
                <div class="relative aspect-[3/4] overflow-hidden">
                    <img src="${product.image}" alt="${name}" class="product-image w-full h-full object-cover cursor-zoom-in" onclick="openLightbox('${product.image}', '${name.replace(/'/g, "\\'")}')">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
